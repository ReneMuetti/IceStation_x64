...
<div align="center">
    ...
    <tr>
      <td height="30" valign="bottom" background="icecast.images/window_menu_bg.png"><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="8"><img src="icecast.images/window_menu_bg_tabsep.png" width="8" height="30" /></td>
          <td width="98" valign="bottom"><img src="icecast.images/menu_button_show_ices_log_selected.png" alt="Show IceLog" width="98" height="30" border="0" /></td>
  ...
  <tr>
    ...
    <td width="430" height="220" bgcolor="#c8ccd2" class="t12b"><label><textarea name="log" class="log" id="log"><?php
      $data = " ";
		$file = "/usr/bin/icestation/var/log/ices0/ices.log";
		if (file_exists($file)) {
